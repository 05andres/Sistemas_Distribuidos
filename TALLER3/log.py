...
class miHandler(SocketServer.BaseRequestHandler):
    def handle(self):
        ...
        self.result1=str(math.log(float(self.array[0]),(float(self.array[1]))))
...
def main():
	print "taller socket"
	host= "localhost"
	puerto =9991 #entre o y 10000 , por los 9000 no estan usados
	server1 = SocketServer.TCPServer((host,puerto),miHandler)
	print "server logaritmica corriendo"
