...
class miHandler(SocketServer.BaseRequestHandler):
    def handle(self):
        ...
        self.exp=float(1/(float(self.array[0])))
        self.result1=str(float(self.array[1])**self.exp)
...
def main():
	print "taller socket"
	host= "localhost"
	puerto =9992 #entre o y 10000 , por los 9000 no estan usados
	server1 = SocketServer.TCPServer((host,puerto),miHandler)
	print "server raiz corriendo"
